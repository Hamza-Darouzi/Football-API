...
public class ClubConfiguration : IEntityTypeConfiguration<Club>
{
    public void Configure(EntityTypeBuilder<Club> builder)
    {
        ...
        builder.HasData(
            new[]
            {
                new Club {Id=1,Name="Fc Barcelona", FoundingDate=new DateTime(1899,11,29),LeagueId=1},
                new Club {Id=2,Name="Real Madrid" , FoundingDate=new DateTime(1902,02,06)  ,LeagueId=1},
